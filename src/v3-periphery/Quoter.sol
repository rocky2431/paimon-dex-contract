...
import {IQuoter} from "../v3-interfaces/periphery/IQuoter.sol";
...
contract Quoter is IQuoter, IPaimonV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IPaimonV3Pool) {
        return IPaimonV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IPaimonV3SwapCallback
